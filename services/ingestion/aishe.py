"""AISHE (All India Survey on Higher Education) statistics ingestion."""
from pathlib import Path

import pandas as pd

from config.data_sources import AISHE_COLUMN_MAP, AISHE_FILE
from services.ingestion.base import add_normalized_key, apply_column_map, load_csv_or_excel


class AISHEIngestion:
    source_name = "AISHE"

    def __init__(self, file_path: Path = None):
        self.file_path = file_path or AISHE_FILE
    ...
    def load(self) -> pd.DataFrame:
        ...
        df = apply_column_map(raw, AISHE_COLUMN_MAP)
        ...
        for col in ["student_enrollment", "faculty_count"]:
